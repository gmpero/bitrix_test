                ...
                <? if ($FIELD == "AUTO_TIME_ZONE" && $arResult["TIME_ZONE_ENABLED"] == true): ?>
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <select class="form-select" name="REGISTER[AUTO_TIME_ZONE]"
                ...
                <? else: ?>
                    <div class="row form-group">
                        <div class="col-md-12">
                            <div class="row form-group">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <label class="font-weight-bold"
                                           for="fullname"><?= GetMessage("REGISTER_FIELD_" . $FIELD) ?>
                                    ...
                                    <? switch ($FIELD) {
                                        ...
                                        case "CONFIRM_PASSWORD":
                                            ?><input type="password" name="REGISTER[<?= $FIELD ?>]"
                                                     value="<?= $arResult["VALUES"][$FIELD] ?>" class="form-control"
                                                     autocomplete="off" /><?
                                            break;
                            ...
                            <!--                            <td>--><?php //= GetMessage("REGISTER_FIELD_" . $FIELD) ?>
                            <!--                                :-->
                            <? // if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"): ?><!--<span-->
...
<!--                <div class="row form-group">-->
<!--                    <div class="col-md-12">-->
<!--                        --><?php //= trim($arParams["USER_PROPERTY_NAME"]) <> '' ? $arParams["USER_PROPERTY_NAME"] : GetMessage("USER_TYPE_EDIT_TAB") ?>
<!--                    </div>-->
<!--                </div>-->
            ...
            if ($arResult["USE_CAPTCHA"] == "Y") {
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <label class="font-weight-bold"
                               for="message"><?= GetMessage("REGISTER_CAPTCHA_TITLE") ?></label>
                        <input type="hidden" class="form-control" name="captcha_sid"
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <label class="font-weight-bold"
                               for="fullname"><?= GetMessage("REGISTER_CAPTCHA_PROMT") ?>:<span
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    <input type="submit" name="register_submit_button" class="btn btn-primary py-2 px-4 rounded-0"
